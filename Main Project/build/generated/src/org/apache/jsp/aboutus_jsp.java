...
public final class aboutus_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<p>\n");
      out.write("\t\t\tGujarat Informatics Ltd.(GIL) was established as the nodal agency for IT development in the state in February 1999, by the Government. of Gujarat. The company was started with a clear objective to promote IT and accelerate the process of E- Governance in the state. Along with the announcement of the IT policy, the Government has enabled GIL to effectively implement IT projects in the state. \n");
      out.write("\n");
      out.write("Since its inception, GIL has worked aggressively to make stunning forays in the implementation of IT in the state. Having made a promising beginning with projects like the INFOCITY, GSWAN and the GR BOOK, GIL is gaining significant ground with its endeavors for computerization of Government departments, training of CIO's, developing applications, forming mergers and signing MOUs with leading national and international companies. These include Microsoft, Reliance, Price Waterhouse Coopers and others.\n");
      out.write(" \n");
      out.write("As the nodal agency for IT in the state and on behalf of the people of Gujarat, we, at GIL, invite you to come and partner with us and reap benefits from the enterprising spirit of Gujarat, its industrial competence and the unshakeable focus on development. \n");
      out.write("\n");
      out.write("Come.... \n");
      out.write("...share the spIrIT of Gujarat ! \n");
      out.write(" \n");
      out.write("\t\t</p>\n");
      out.write("\t\t\n");
      out.write("\t</div>\n");
